...
namespace _Code.Apple
{
    public class BoundingBox : MonoBehaviour, IPositionRandomizer
    {
        ...
        public Vector3 GetRandomPositionInside()
        {
            ...
            Vector3 min = this.transform.position + _centerPos - _dimensions * 0.5f;
            Vector3 max = this.transform.position + _centerPos + _dimensions * 0.5f;
        ...
        {
            Gizmos.DrawWireCube(this.transform.position + _centerPos,_dimensions);
        }
    }
}